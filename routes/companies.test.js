...
describe("GET /companies with query filters", function () {
  test("pass: query strings: name, minEmployee, and maxEmployee", async function () {
    const resp = await request(app)
      .get("/companies")
  ...
  test("pass: wide min and max values", async function () {
    const resp = await request(app)
      .get("/companies")
  ...
  test("pass: allow negative numbers, empty array", async function () {
    const resp = await request(app)
      .get("/companies")
  ...
  test("pass: no name match, empty array", async function () {
